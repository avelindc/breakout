...
export function UploadForm({ artists, userId }: { artists: any[]; userId: string }) {
  ...
  const [selectedPlatforms, setSelectedPlatforms] = useState<string[]>(
    STREAMING_PLATFORMS.map(p => p.id)
  );
    ...
    <>
      ...
      {success ? (
        ...
        <form id="metadata-upload-form" onSubmit={handleFormSubmit} className="bg-gradient-to-br from-[#f000ff] to-[#8a2be2] text-white border border-white/10 shadow-[0_8px_30px_rgba(240,0,255,0.25)] rounded-[2rem] p-6 md:p-8 space-y-8">
          ...
          {/* STEP 2: Platform Selection & TikTok Clip Time */}
          {step === 2 && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="p-6 bg-white/5 rounded-2xl border border-white/10 space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h4 className="font-bold text-lg">TikTok Start Time</h4>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <option value="00:30">Detik 30 (00:30) - (Direkomendasikan)</option>
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/10 pb-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Total {selectedPlatforms.length} platform dipilih</p>
                  </div>
                  <button
                    type="button"
              ...
              <div className="flex gap-4 pt-4 border-t border-white/10">
                ...
                <button
                  ...
                  className="flex-[2] py-4 rounded-2xl bg-gradient-to-r from-teal-400 to-blue-500 disabled:opacity-50 text-white font-bold text-base hover:opacity-95 transition flex items-center justify-center gap-2 shadow-lg shadow-teal-500/25 animate-pulse"
                >
