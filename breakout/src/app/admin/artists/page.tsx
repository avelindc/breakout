          ...
          {pendingUsers.map((user) => (
            ...
            >
              ...
              <div className="flex-1 flex items-center gap-3">
                <img src={user.image || `https://api.dicebear.com/7.x/avataaars/svg?seed=${user.name}`} alt="Profile" className="w-8 h-8 rounded-full bg-gray-100 object-cover" />
                <span className="font-bold text-gray-900 group-hover:text-white transition">{user.artist?.stageName || user.name}</span>
              </div>
              
              <div className="flex-1 text-gray-500 text-sm group-hover:text-blue-100">
                {user.email}
              </div>
