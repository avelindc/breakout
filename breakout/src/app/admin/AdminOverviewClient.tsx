          ...
          <div className="fundflow-glass rounded-[2rem] p-8 relative overflow-hidden">
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <h2 className="text-5xl font-semibold text-slate-800">Rp {(data.totalRevenue / 1000000).toFixed(1)}M</h2>
              </div>
            ...
            <div className="flex items-center justify-between relative z-10 mt-12 mb-4">
              <div className="flex items-center">
                {/* Circle 1 */}
                <div className="w-32 h-32 rounded-full bg-white/80 backdrop-blur-lg flex flex-col items-center justify-center border border-white shadow-sm z-20 relative">
                ...
                {/* Circle 3 */}
                <div className="w-32 h-32 rounded-full bg-white/80 backdrop-blur-lg flex flex-col items-center justify-center border border-white shadow-sm z-20 -ml-10 relative">
                  <span className="text-lg font-bold text-slate-800">Rp {(data.pendingWithdrawals / 1000000).toFixed(1)}M</span>
                  <span className="text-xs text-slate-500 font-medium">Pending WD</span>
                </div>
              </div>
