...
export default async function MaintenancePage() {
  ...
  return (
    <main className="min-h-screen bg-[#09090B] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl bg-white/[0.02] backdrop-blur-xl border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(240,0,255,0.05)] text-center relative z-10 flex flex-col items-center">
        {/* Logo */}
        <div className="w-40 h-16 mb-8 relative">
          <Image src={brandLogo} alt="BREAKOUT.ID" fill className="object-contain" priority />
        </div>

        {/* Animated Icon */}
        <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-[#f000ff] to-[#8a2be2] flex items-center justify-center mb-8 shadow-[0_0_30px_rgba(240,0,255,0.3)] relative group">
        ...
        {/* Message Container */}
        <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6 md:p-8 w-full max-w-lg mb-8 shadow-inner">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full max-w-lg mb-8 text-left">
          ...
          {endVal && (
            <div className="col-span-full bg-white/[0.03] border border-[#00F0FF]/10 rounded-xl p-4 flex items-center gap-3 shadow-[0_0_15px_rgba(0,240,255,0.02)]">
