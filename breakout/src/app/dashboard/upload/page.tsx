...
export default function UploadMusicPage() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setLoading(false);
      setError(err.message || "An unexpected error occurred during upload. Please check file size or try again.");
    }
  }
        ...
        <form onSubmit={handleSubmit} className="glass-card p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <label className="text-sm font-medium text-gray-300">Primary Artist (Leave empty for default)</label>
                <input name="primaryArtist" type="text" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 outline-none focus:border-[#00F0FF] transition" placeholder="Optional" />
              </div>
            </div>
